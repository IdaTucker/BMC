...
At a given location, reduce the formula so as to recognize if we have already been i this location with this formula. Indeed the implemented bounded model checker does not check if a location has been \textit{visited}.
